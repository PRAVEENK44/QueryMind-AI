...
class IntentParser:
    ...
    def _detect_group_by(self, query: str) -> str | None:
    ...
    def _detect_city(self, query: str) -> str | None:
    ...
    def _detect_chart_type(self, query: str, group_by: str | None, time_range: str | None) -> str:
